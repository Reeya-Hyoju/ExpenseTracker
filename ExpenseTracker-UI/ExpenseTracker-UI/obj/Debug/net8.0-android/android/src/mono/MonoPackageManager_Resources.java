...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ExpenseTracker-UI.dll" comes first in this list. */
		"ExpenseTracker-UI.dll",
		"GoogleGson.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"ExpenseTracker.Application.dll",
		"ExpenseTracker.Domain.dll",
		"ExpenseTracker.Infrastructure.dll",
